function  graphivconstantintensity(intensity,Reflection,wavelengthnm)
bandgap=1.1;
...
temperaturearray=[273 298 323 348 ];
...
for Vopen=0:0.01:0.9
    ...
    for temperatureindex=1:4
      ...
      %  VOCP=opencircuit(temperature,dopingdensityp,chargecarriers,ni);
        ...
        currenttotal(temperatureindex,k) = totalI;
...
title('Graph of I-V varying temperature')
legend('T=0','T=25','T=50','T=75');
